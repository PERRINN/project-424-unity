...
// The Alpha channel of the Albedo texture masks the areas that must be painted with the Paint color


Shader "Vehicle Physics/Masked Car Paint"
	{
	Properties
		{
	...
	SubShader
		...
		void surf (Input IN, inout SurfaceOutputStandard o)
			...
			o.Albedo = albedo * (c.a * _Paint.rgb + (1-c.a) * _Color.rgb);
