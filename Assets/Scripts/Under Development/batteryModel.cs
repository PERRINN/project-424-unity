...
public class batteryModel : MonoBehaviour
{
    ...
    private void FixedUpdate()
    {
        ...
        m_text = "Battery State of Charge (%): " + System.Math.Round(batterySOC) + "\n";
        m_text += "Battery Depth of Discharge (%): " + System.Math.Round(batteryDOD) + "\n";
        m_text += "Power Used (kWh): " + powerTotal + "\n";
