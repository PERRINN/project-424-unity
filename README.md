...
>
> Commits pushed to this repository during that window contained a malicious VS Code auto-run task. If you cloned, pulled or forked in that period, please check your copy and re-clone: see [#96](https://github.com/PERRINN/project-424-unity/issues/96). Current forks are unaffected.
